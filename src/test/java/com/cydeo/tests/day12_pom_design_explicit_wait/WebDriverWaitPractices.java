...
public class WebDriverWaitPractices {
    ...
    public void dynamic_load_7_test(){
        ...
        //Creating the web object to be able to create certain condition to wait
        ...
        wait.until(ExpectedConditions.elementToBeClickable(dynamicLoad7Page.spongeBobImage));
